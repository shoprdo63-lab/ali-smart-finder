const I="ali_smart_finder_v1",_="https://ali-smart-finder.onrender.com",h="wc-price-hunter-box",v={CONFIG:"wc_price_hunter_config",POSITION:"wc_price_hunter_position",LAST_SEARCH:"wc_price_hunter_last_search"},P={backendApiUrl:_,enabled:!0,autoShow:!0};let p={isVisible:!1,isMinimized:!1,isLoading:!1,position:{x:20,y:150}},b={...P},l=null;(function(){const t=window.location.host;U().then(()=>{if(!b.enabled){console.log("WC Price Hunter: Extension disabled");return}t.includes("amazon")&&(F(),B())}).catch(i=>{console.error("WC Price Hunter initialization error:",i)})})();async function F(){try{document.querySelector('.s-main-slot, [data-component-type="s-search-result"]')!==null?await k():await C()}catch(t){console.error("WC Price Hunter (Amazon handler):",t)}}async function k(){const t=document.querySelectorAll('.s-main-slot .s-result-item, [data-component-type="s-search-result"]');console.log(`WC Price Hunter: Found ${t.length} products on search page`),t.forEach((i,e)=>{const r=L(i);r&&M(i,r,e)})}function L(t){var i,e;try{const r=t.querySelector('h2 a span, .s-size-mini span, [data-cy="title-recipe-title"]'),a=((i=r==null?void 0:r.textContent)==null?void 0:i.trim())||"";if(!a)return null;const n=t.querySelector(".a-price .a-offscreen, .a-price-whole"),c=(((e=n==null?void 0:n.textContent)==null?void 0:e.trim())||"").replace(/[^\d.,]/g,"");let s=t.getAttribute("data-asin")||"";if(!s){const u=t.querySelector('a[href*="/dp/"]');if(u){const f=u.href.match(/\/dp\/([A-Z0-9]{10})/);s=f?f[1]:""}}const d=t.querySelector('h2 a, a[href*="/dp/"]'),m=d?d.href.startsWith("http")?d.href:`https://www.amazon.com${d.getAttribute("href")}`:"",g=t.querySelector(".s-image"),x=(g==null?void 0:g.src)||"";return{title:a,price:c,currency:"USD",url:m||window.location.href,asin:s,imageUrl:x}}catch(r){return console.error("Error extracting product from search item:",r),null}}function M(t,i,e){if(t.querySelector(".wc-price-hunter-panel"))return;const a=document.createElement("div");a.className="wc-price-hunter-panel",a.dataset.asin=i.asin,a.dataset.index=String(e),Object.assign(a.style,{marginTop:"10px",padding:"12px",background:"linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.1)",color:"#fff",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontSize:"13px",zIndex:"1000"}),a.innerHTML=`
  ...
  `;const n=a.querySelector(".wc-hunter-search-btn");n&&n.addEventListener("click",()=>{z(i)}),t.appendChild(a)}function B(){new MutationObserver(i=>{let e=!1,r=!1;i.forEach(a=>{a.addedNodes.forEach(n=>{var o,c,s,d;n instanceof HTMLElement&&(((o=n.matches)!=null&&o.call(n,'.s-result-item, [data-component-type="s-search-result"]')||(c=n.querySelector)!=null&&c.call(n,'.s-result-item, [data-component-type="s-search-result"]'))&&(e=!0),((s=n.matches)!=null&&s.call(n,"#productTitle, #ppd, #centerCol, #title_feature_div, #apex_desktop, #corePrice_feature_div")||(d=n.querySelector)!=null&&d.call(n,"#productTitle, #ppd, #centerCol, #buybox_feature_div"))&&(r=!0))})}),clearTimeout(window.__wcHunterTimeout),e&&(window.__wcHunterTimeout=setTimeout(()=>{k()},500)),r&&(window.__wcHunterTimeout=setTimeout(()=>{const a=document.querySelector("#productTitle, #ppd")!==null,n=document.getElementById(h);a&&!n&&b.autoShow&&C()},800))}).observe(document.body,{childList:!0,subtree:!0}),console.log("WC Price Hunter: MutationObserver active - watching for Amazon products")}async function C(){const t=T();if(!t){console.log("WC Price Hunter: Could not extract Amazon product info");return}console.log("WC Price Hunter: Found Amazon product:",t.title),b.autoShow?await z(t):q(t)}function H(t,i){if(!i)return"";if(i.includes("s.click.aliexpress.com")||i.includes("aff_short_key"))return i;const e=i.match(/\/item\/(\d+)\.html/);return e?`https://www.aliexpress.com/item/${e[1]}.html`:i.startsWith("http://")||i.startsWith("https://")?i:`https://www.aliexpress.com${i.startsWith("/")?"":"/"}${i}`}function $(t){let i=t.replace(/[|:\-]/g," ");[/\b(glacier|charcoal|white|black|red|blue|green|yellow|orange|purple|pink|gray|grey|silver|gold)\b/gi,/\b(bundle|pack|set|kit)\b/gi].forEach(n=>{i=i.replace(n," ")});const a=i.split(/\s+/).filter(n=>n.length>0).slice(0,4).join(" ");return console.log(`🧹 Sanitized: "${t}" → "${a}"`),a.trim()}async function U(){return new Promise(t=>{chrome.storage.sync.get([v.CONFIG],i=>{i[v.CONFIG]&&(b={...P,...i[v.CONFIG]}),t()})})}function T(){var t,i,e,r;try{const a=["#productTitle",'[data-automation-id="title"]',".product-title","h1.a-size-large"];let n=null;for(const y of a)if(n=document.querySelector(y),(t=n==null?void 0:n.textContent)!=null&&t.trim())break;const o=((i=n==null?void 0:n.textContent)==null?void 0:i.trim())||"";if(!o)return null;const c=[".a-price .a-offscreen",".a-price-whole",'[data-automation-id="price"]',".priceToPay"];let s=null;for(const y of c)if(s=document.querySelector(y),(e=s==null?void 0:s.textContent)!=null&&e.trim())break;const m=(((r=s==null?void 0:s.textContent)==null?void 0:r.trim())||"").replace(/[^\d.,]/g,""),g=window.location.pathname.match(/\/dp\/([A-Z0-9]{10})/),x=g?g[1]:"",u=document.querySelector("#landingImage, #imgBlkFront"),f=(u==null?void 0:u.src)||void 0;return{title:o,price:m,currency:"USD",url:window.location.href,asin:x,imageUrl:f}}catch(a){return console.error("Error extracting Amazon product:",a),null}}async function O(t){var i;try{console.log("🔍 Searching AliExpress for:",t);const e=$(t),r=`${b.backendApiUrl}/api/search?query=${encodeURIComponent(e)}`,a=await fetch(r,{method:"GET",headers:{"Content-Type":"application/json"}});if(!a.ok)throw new Error(`API request failed: ${a.status}`);const n=await a.json();if(console.log("📦 API Response:",n),!n.success||!n.data)throw new Error(((i=n.error)==null?void 0:i.message)||"No matching product found");const o=n.data;return{aliPrice:parseFloat(o.aliPrice)||0,aliUrl:o.aliUrl||"",image:o.image||"",title:o.aliTitle||"",aliTitle:o.aliTitle||"",totalCost:o.totalCost||0,shipping:o.shipping||0,originalPrice:parseFloat(o.originalPrice)||0,discount:o.discount||0,rating:o.rating||0,orders:o.orders||0,seller:o.seller||"AliExpress",matchConfidence:o.matchConfidence||0,coupon:o.coupon||null,alternatives:o.alternatives||[]}}catch(e){throw console.error("❌ Error matching Amazon product:",e),e}}async function z(t){var i;try{w({isLoading:!0});const e=await O(t.title);if(!e){w({isLoading:!1,error:"No AliExpress match found"});return}const r=parseFloat((t.price||"0").replace(/[^\d.]/g,""))||0,a=parseFloat(String(e.aliPrice||e.totalCost||0))||0;let n;if(a>0&&a<r){const S=r-a,E=Math.round(S/r*100);n={amount:S,percentage:E}}const o=e.aliUrl||"",c=o?H(I,o):"",s=((i=o.match(/\/item\/(\d+)\.html/))==null?void 0:i[1])||"",d=(e.aliTitle||e.title||"AliExpress Product").substring(0,100),m=String(e.aliPrice||0),g=String(e.originalPrice||e.aliPrice||0),x=typeof e.rating=="string"?parseFloat(e.rating)||0:e.rating||0,u=typeof e.orders=="string"?parseInt(e.orders)||0:e.orders||0,f={id:s,title:d,salePrice:m,originalPrice:g,currency:"USD",imageUrl:e.image||"",productUrl:o,affiliateUrl:c||o,discount:e.discount||0,rating:x,orders:u,packageType:"Standard",seller:{name:e.seller||"AliExpress",rating:x||4.5}};w({isLoading:!1,comparison:{amazon:t,aliexpress:[f],cheapestAliExpress:f,savings:n}})}catch(e){console.error("Error in price comparison:",e),w({isLoading:!1,error:e instanceof Error?e.message:"Unknown error"})}}function q(t){const i=document.getElementById("wc-price-hunter-toggle");i&&i.remove();const e=document.createElement("div");e.id="wc-price-hunter-toggle",e.innerHTML="💰",Object.assign(e.style,{position:"fixed",top:"150px",right:"20px",width:"50px",height:"50px",background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"24px",cursor:"pointer",zIndex:"1000000",boxShadow:"0 4px 15px rgba(0,0,0,0.2)",transition:"all 0.3s ease"}),e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.1)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{z(t),e.remove()}),document.body.appendChild(e)}function w(t){p={...p,...t};let i=document.getElementById(h);i||(i=D(),document.body.appendChild(i)),A(i),p.isVisible?(i.style.display="block",Y(i)):i.style.display="none"}function D(){const t=document.createElement("div");return t.id=h,Object.assign(t.style,{position:"fixed",top:`${p.position.y}px`,left:`${p.position.x}px`,width:"380px",background:"linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)",borderRadius:"16px",boxShadow:"0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.1)",zIndex:"1000000",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontSize:"14px",display:"none",overflow:"hidden",border:"1px solid rgba(102, 126, 234, 0.3)"}),t}function A(t){if(p.isLoading){t.innerHTML=`
    ...
    `;return}if(!p.comparison)return;const{amazon:i,cheapestAliExpress:e,savings:r}=p.comparison;t.innerHTML=`
    ...
    `}
  `,p.isVisible=!0,setTimeout(()=>{const a=t.querySelector("#view-full-comparison-btn"),n=t.querySelector("#download-images-btn");a&&a.addEventListener("click",()=>{if(e){const o=$(i.title),c=`https://www.aliexpress.com/wholesale?SearchText=${encodeURIComponent(o)}`;window.open(c,"_blank")}}),n&&n.addEventListener("click",async()=>{try{const o=n;o.textContent="⏳ Downloading...";const c=[{url:i.imageUrl,name:"amazon-product.jpg"},{url:e==null?void 0:e.imageUrl,name:"aliexpress-product.jpg"}].filter(s=>s.url);for(const s of c){const d=document.createElement("a");d.href=s.url,d.download=s.name,d.target="_blank",document.body.appendChild(d),d.click(),document.body.removeChild(d),await new Promise(m=>setTimeout(m,500))}o.textContent="✓ Downloaded!",setTimeout(()=>{o.textContent="🖼️ Download Images"},2e3)}catch(o){console.error("Error downloading images:",o);const c=n;c.textContent="❌ Error",setTimeout(()=>{c.textContent="🖼️ Download Images"},2e3)}})},100)}function Y(t){if(l)return;l={element:t,isDragging:!1,startX:0,startY:0,initialX:0,initialY:0};const i=t.querySelector('div[style*="cursor: move"]');i&&(i.addEventListener("mousedown",R),document.addEventListener("mousemove",j),document.addEventListener("mouseup",N))}function R(t){if(!l)return;l.isDragging=!0,l.startX=t.clientX,l.startY=t.clientY;const i=l.element.getBoundingClientRect();l.initialX=i.left,l.initialY=i.top,l.element.style.transition="none"}function j(t){if(!(l!=null&&l.isDragging))return;t.preventDefault();const i=t.clientX-l.startX,e=t.clientY-l.startY,r=l.initialX+i,a=l.initialY+e,n=window.innerWidth-l.element.offsetWidth,o=window.innerHeight-l.element.offsetHeight,c=Math.max(0,Math.min(r,n)),s=Math.max(0,Math.min(a,o));l.element.style.left=`${c}px`,l.element.style.top=`${s}px`,p.position={x:c,y:s}}function N(){l&&(l.isDragging=!1,l.element.style.transition="",chrome.storage.sync.set({[v.POSITION]:p.position}))}chrome.runtime.onMessage.addListener((t,i,e)=>{if(t.action==="getProductInfo"){try{const r=T();r&&r.title?e({product:{title:r.title,price:r.price,asin:r.asin,image:r.imageUrl||""}}):e({product:null,error:"No product found on this page"})}catch(r){e({product:null,error:r.message||"Unknown error"})}return!0}});window.toggleMinimize=()=>{p.isMinimized=!p.isMinimized;const t=document.getElementById(h);t&&A(t)};
