const E="ali_smart_finder_v1",T="http://localhost:3000",x="wc-price-hunter-box",v={CONFIG:"wc_price_hunter_config",POSITION:"wc_price_hunter_position",LAST_SEARCH:"wc_price_hunter_last_search"},k={backendApiUrl:T,enabled:!0,autoShow:!0};let c={isVisible:!1,isMinimized:!1,isLoading:!1,position:{x:20,y:150}},b={...k},a=null;(function(){const t=window.location.host;H().then(()=>{if(!b.enabled){console.log("WC Price Hunter: Extension disabled");return}t.includes("amazon")&&(I(),F())}).catch(i=>{console.error("WC Price Hunter initialization error:",i)})})();async function I(){try{document.querySelector('.s-main-slot, [data-component-type="s-search-result"]')!==null?await P():await _()}catch(t){console.error("WC Price Hunter (Amazon handler):",t)}}async function P(){const t=document.querySelectorAll('.s-main-slot .s-result-item, [data-component-type="s-search-result"]');console.log(`WC Price Hunter: Found ${t.length} products on search page`),t.forEach((i,e)=>{const r=L(i);r&&M(i,r,e)})}function L(t){var i,e;try{const r=t.querySelector('h2 a span, .s-size-mini span, [data-cy="title-recipe-title"]'),o=((i=r==null?void 0:r.textContent)==null?void 0:i.trim())||"";if(!o)return null;const n=t.querySelector(".a-price .a-offscreen, .a-price-whole"),d=(((e=n==null?void 0:n.textContent)==null?void 0:e.trim())||"").replace(/[^\d.,]/g,"");let s=t.getAttribute("data-asin")||"";if(!s){const g=t.querySelector('a[href*="/dp/"]');if(g){const m=g.href.match(/\/dp\/([A-Z0-9]{10})/);s=m?m[1]:""}}const p=t.querySelector('h2 a, a[href*="/dp/"]'),h=p?p.href.startsWith("http")?p.href:`https://www.amazon.com${p.getAttribute("href")}`:"",u=t.querySelector(".s-image"),f=(u==null?void 0:u.src)||"";return{title:o,price:d,currency:"USD",url:h||window.location.href,asin:s,imageUrl:f}}catch(r){return console.error("Error extracting product from search item:",r),null}}function M(t,i,e){if(t.querySelector(".wc-price-hunter-panel"))return;const o=document.createElement("div");o.className="wc-price-hunter-panel",o.dataset.asin=i.asin,o.dataset.index=String(e),Object.assign(o.style,{marginTop:"10px",padding:"12px",background:"linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.1)",color:"#fff",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontSize:"13px",zIndex:"1000"}),o.innerHTML=`
  ...
  `;const n=o.querySelector(".wc-hunter-search-btn");n&&n.addEventListener("click",()=>{z(i)}),t.appendChild(o)}function F(){new MutationObserver(i=>{let e=!1,r=!1;i.forEach(o=>{o.addedNodes.forEach(n=>{var l,d,s,p;n instanceof HTMLElement&&(((l=n.matches)!=null&&l.call(n,'.s-result-item, [data-component-type="s-search-result"]')||(d=n.querySelector)!=null&&d.call(n,'.s-result-item, [data-component-type="s-search-result"]'))&&(e=!0),((s=n.matches)!=null&&s.call(n,"#productTitle, #ppd, #centerCol, #title_feature_div, #apex_desktop, #corePrice_feature_div")||(p=n.querySelector)!=null&&p.call(n,"#productTitle, #ppd, #centerCol, #buybox_feature_div"))&&(r=!0))})}),clearTimeout(window.__wcHunterTimeout),e&&(window.__wcHunterTimeout=setTimeout(()=>{P()},500)),r&&(window.__wcHunterTimeout=setTimeout(()=>{const o=document.querySelector("#productTitle, #ppd")!==null,n=document.getElementById(x);o&&!n&&b.autoShow&&_()},800))}).observe(document.body,{childList:!0,subtree:!0}),console.log("WC Price Hunter: MutationObserver active - watching for Amazon products")}async function _(){const t=$();if(!t){console.log("WC Price Hunter: Could not extract Amazon product info");return}console.log("WC Price Hunter: Found Amazon product:",t.title),b.autoShow?await z(t):B(t)}function U(t,i){const e=i.match(/\/item\/(\d+)\.html/),r=e?e[1]:"";if(r)return`https://s.click.aliexpress.com/deep_link.htm?aff_short_key=${t}&aff_key=${t}&dl_target_url=https://www.aliexpress.com/item/${r}.html`;const o=encodeURIComponent(i);return`https://s.click.aliexpress.com/deep_link.htm?aff_short_key=${t}&dl_target_url=${o}`}async function H(){return new Promise(t=>{chrome.storage.sync.get([v.CONFIG],i=>{i[v.CONFIG]&&(b={...k,...i[v.CONFIG]}),t()})})}function $(){var t,i,e,r;try{const o=["#productTitle",'[data-automation-id="title"]',".product-title","h1.a-size-large"];let n=null;for(const y of o)if(n=document.querySelector(y),(t=n==null?void 0:n.textContent)!=null&&t.trim())break;const l=((i=n==null?void 0:n.textContent)==null?void 0:i.trim())||"";if(!l)return null;const d=[".a-price .a-offscreen",".a-price-whole",'[data-automation-id="price"]',".priceToPay"];let s=null;for(const y of d)if(s=document.querySelector(y),(e=s==null?void 0:s.textContent)!=null&&e.trim())break;const h=(((r=s==null?void 0:s.textContent)==null?void 0:r.trim())||"").replace(/[^\d.,]/g,""),u=window.location.pathname.match(/\/dp\/([A-Z0-9]{10})/),f=u?u[1]:"",g=document.querySelector("#landingImage, #imgBlkFront"),m=(g==null?void 0:g.src)||void 0;return{title:l,price:h,currency:"USD",url:window.location.href,asin:f,imageUrl:m}}catch(o){return console.error("Error extracting Amazon product:",o),null}}async function O(t){var i;try{const e=await fetch(`${b.backendApiUrl}/api/search?query=${encodeURIComponent(t)}`,{method:"GET",headers:{"Content-Type":"application/json"}});if(!e.ok)throw new Error(`API request failed: ${e.status}`);const r=await e.json();if(!r.success||!r.data)throw new Error(((i=r.error)==null?void 0:i.message)||"No matching product found");return r.data}catch(e){throw console.error("Error matching Amazon product:",e),e}}async function z(t){var i;try{w({isLoading:!0});const e=await O(t.title);if(!e){w({isLoading:!1,error:"No AliExpress match found"});return}const r=parseFloat((t.price||"0").replace(/[^\d.]/g,""))||0,o=parseFloat(String(e.aliPrice||e.totalCost||0))||0;let n;if(o>0&&o<r){const S=r-o,C=Math.round(S/r*100);n={amount:S,percentage:C}}const l=e.aliUrl||"",d=l?U(E,l):"",s=((i=l.match(/\/item\/(\d+)\.html/))==null?void 0:i[1])||"",p=(e.aliTitle||e.title||"AliExpress Product").substring(0,100),h=String(e.aliPrice||0),u=String(e.originalPrice||e.aliPrice||0),f=typeof e.rating=="string"?parseFloat(e.rating)||0:e.rating||0,g=typeof e.orders=="string"?parseInt(e.orders)||0:e.orders||0,m={id:s,title:p,salePrice:h,originalPrice:u,currency:"USD",imageUrl:e.image||"",productUrl:l,affiliateUrl:d||l,discount:e.discount||0,rating:f,orders:g,packageType:"Standard",seller:{name:e.seller||"AliExpress",rating:f||4.5}};w({isLoading:!1,comparison:{amazon:t,aliexpress:[m],cheapestAliExpress:m,savings:n}})}catch(e){console.error("Error in price comparison:",e),w({isLoading:!1,error:e instanceof Error?e.message:"Unknown error"})}}function B(t){const i=document.getElementById("wc-price-hunter-toggle");i&&i.remove();const e=document.createElement("div");e.id="wc-price-hunter-toggle",e.innerHTML="💰",Object.assign(e.style,{position:"fixed",top:"150px",right:"20px",width:"50px",height:"50px",background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"24px",cursor:"pointer",zIndex:"1000000",boxShadow:"0 4px 15px rgba(0,0,0,0.2)",transition:"all 0.3s ease"}),e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.1)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{z(t),e.remove()}),document.body.appendChild(e)}function w(t){c={...c,...t};let i=document.getElementById(x);i||(i=q(),document.body.appendChild(i)),A(i),c.isVisible?(i.style.display="block",D(i)):i.style.display="none"}function q(){const t=document.createElement("div");return t.id=x,Object.assign(t.style,{position:"fixed",top:`${c.position.y}px`,left:`${c.position.x}px`,width:"380px",background:"linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)",borderRadius:"16px",boxShadow:"0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.1)",zIndex:"1000000",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontSize:"14px",display:"none",overflow:"hidden",border:"1px solid rgba(102, 126, 234, 0.3)"}),t}function A(t){if(c.isLoading){t.innerHTML=`
